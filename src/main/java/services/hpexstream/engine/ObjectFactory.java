 ...
 * generated in the services.hpexstream.engine package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: services.hpexstream.engine
     * 
     */
